...
const recruiters = require("./recruiters.js")
const postings = {
    '2a0cb1db-856e-4f89-8192-b20f37833912': {
    ...
    '94fbd69d-591b-4dbf-8d0b-f3c69a97dc2c': {
    ...
    '26ff9230-817b-4eeb-818f-99e37334e25e': {
    ...
    '720e4089-62f1-444b-8c89-15630ec5c0c1': {
    ...
    'b0a18085-4256-4e1a-a304-121f4594a84e': {
    ...
    'daff206d-255f-48a1-89ce-a97fb44815b7': {
    ...
    '7a2cf219-2556-4439-8c03-14d037b082bd': {
    ...
    'e7a0ab21-6688-481d-9476-55646ab28059': {
      title: 'Software Engineer',
    ...
    '740578e5-51cc-44f6-aa1d-43de217736fb': {
...
function addPosting({username, posting}) {
        const postingId = uuid()
        const updatedPosting = {...posting, 'postedBy': username, postingId }
        console.log('i am in updated posting',updatedPosting)
        postings[postingId] = updatedPosting;
        console.log(postings);
        recruiters.addToRecruiterPostings({username, posting: updatedPosting , applicants: []})
        console.log(postings, postings);
        console.log('recruiters-posts', recruiters.getRecruiterPostings(username))
    }


function addApplicantToPostings({username,postingId}) {
    if (!postings[postingId]['applicants'].includes(username)) {
        postings[postingId]['applicants'].push(username)
    }
}
